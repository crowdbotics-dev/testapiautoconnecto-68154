...
## Project Structure
    ...
    ├── testapiautoconnecto_68154  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_68154`
...
2. Clone this repo and `cd testapiautoconnecto_68154`
